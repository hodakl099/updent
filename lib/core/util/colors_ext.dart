...
extension colors on ColorScheme {
  static const Color primary = Color(0xffE00000); // Updated primary color
  static const Color darkprimary = Colors.white;

  static MaterialColor primary_app = const MaterialColor(
    0xffE00000, // Updated primary color
    <int, Color>{
      50: primary,
      100: primary,
      200: primary,
  ...
  static const Color darksecondary = Color(0xff4AB0FF);

  Color get primarytheme =>
      brightness == Brightness.dark ? darkprimary : primary;

  Color get textColor => darkColor;

  Color get priamryTextIConColor =>
      brightness == Brightness.dark ? darkColor : primary;

  Color get primaryTexttheme =>
      brightness == Brightness.dark ? primary : darkprimary;
  ...
  Color get lightWhiteText =>
      brightness == Brightness.dark ? darkColor : const Color(0xffF5F5F5);

  Color get fontColor =>
      brightness == Brightness.dark ? whiteTemp : const Color(0xff182230);
  ...
  Color get simmerBase =>
      brightness == Brightness.dark ? darkColor2 : Colors.grey[400]!;
  ...
  Color get colorGrey800 => Color(0xff5E6368);
